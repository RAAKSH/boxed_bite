...
export const CardComponent = (props) => {
  ...
  return (
    <div className="m-2 p-2 w-[250px] bg-gray-100 hover:bg-slate-300 border border-solid rounded-sm shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
      <img
        src={IMAGE_URL + info?.cloudinaryImageId}
        alt="res-logo"
        className="px-0.5 object-cover w-80 h-60  border border-solid rounded-lg"
      />
